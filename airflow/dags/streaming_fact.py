...
with DAG(
    dag_id='fact_ingestion_streaming_dag',
    ...
    fact_ingestion = SparkSubmitOperator(
        task_id='staging_ingestion',
        conn_id="spark_default",
        application='/user/local/spark/app/fact_stream_ingest.py',
...
start_task >> fact_ingestion >> end_task
